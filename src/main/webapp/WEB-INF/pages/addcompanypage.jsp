...
<html>
<head>
  <title>"AVIA / Spring-Hibernate" - Add Company Page</title>
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/style.css"/>
</head>

<body>

<div class ="head"><span class="head1">Add company</span></div>
<p>
...
<table class="tb_main">
  <tr align="center">
    <td valign="top" align="right" width="40%">
      ...
      <form:form method="POST" action="companyAddAction" modelAttribute="Company">
